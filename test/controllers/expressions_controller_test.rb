...
class ExpressionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create expression" do
    assert_difference("Expression.count") do
      post expressions_url, params: { expression: { article_id: @expression.article_id, comments: @expression.comments, likes: @expression.likes, user_id: @expression.user_id } }
    end
  ...
  test "should update expression" do
    patch expression_url(@expression), params: { expression: { article_id: @expression.article_id, comments: @expression.comments, likes: @expression.likes, user_id: @expression.user_id } }
